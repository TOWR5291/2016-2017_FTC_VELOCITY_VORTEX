...
@Autonomous(name="Pushbot: Auto Drive Red Andrew", group="5291Test")
//@Disabled
public class AutoDriveRedAndrew extends OpMode {
    ...
    private LibraryStateSegAuto[] mRobotAutonomous = {
            ...
            //                        out   ing   ance  r
            //                         s    deg   inch   %
            //new LibraryStateSegAuto ( 10,  "L0",   96,  1 ),
            new LibraryStateSegAuto ( 10,  "R90", 10,  1 ),
            //new LibraryStateSegAuto ( 10,  "R0",   48, 0.5)
    };
