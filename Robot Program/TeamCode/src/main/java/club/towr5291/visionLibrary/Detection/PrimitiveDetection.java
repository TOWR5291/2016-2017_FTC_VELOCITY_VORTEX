package club.towr5291.visionLibrary.Detection;
...
import club.towr5291.visionLibrary.Image.Filter;
...
public class PrimitiveDetection {
    ...
    public static EllipseLocationResult locateEllipses(Mat grayImage) {
        ...
        Imgproc.findContours(gray, contoursTemp, cacheHierarchy, Imgproc.RETR_TREE, Imgproc.CHAIN_APPROX_TC89_KCOS);
    ...
    public RectangleLocationResult locateRectangles(Mat grayImage) {
        ...
        Imgproc.findContours(grayTemp, contoursTemp, cacheHierarchy, Imgproc.RETR_LIST, Imgproc.CHAIN_APPROX_SIMPLE);
